...
ребра внутри заданного треугольника или нет. Если лежат, то ребро лежит в треугольнике, в противном случае - нет. Для того, чтобы узнать принадлежит ли точка треугольнику используется так называемое псевдоскалярное произведение векторов на плоскости.
