...
Основная идея решения задачи заключается в установлении того, лежат ли оба конца
ребра выпуклой оболочки внутри заданного треугольника или нет. Если лежат, то ребро полностью лежит в треугольнике, в противном случае — нет. Для того, чтобы узнать принадлежит ли точка треугольнику, используется так называемое псевдоскалярное произведение векторов на плоскости.
